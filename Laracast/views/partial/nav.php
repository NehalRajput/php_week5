      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            <a href="/" class="<?= urlIs('/index') ? 'bg-gray-900 text-white ' : 'text-gray-300 '; ?> hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">Home</a>
            ...
            <a href="/contact" class="<?= urlIs('/contact') ? 'bg-gray-900 text-white ' : 'text-gray-300 '; ?> hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">Contact Us</a>
          </div>
        </div>
      </div>
      <div class="hidden md:block">
            ...
            <?php if ($_SESSION['user'] ?? false): ?>
              ...
              <div class="flex items-center space-x-3">
                ...
                <form method="POST" action="/session">
                  ...
                  <button class="text-white px-3 py-2 bg-white-600 rounded-md hover:bg-gray-700">Log Out</button>
                </form>
              </div>
            <?php else: ?>
              ...
              <a href="/login" class="<?= urlIs('/login') ? 'bg-gray-900 text-white ' : 'text-gray-300 '; ?> hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">Log in</a>
            <?php endif; ?>
          </div>
        </div>
      </div>
